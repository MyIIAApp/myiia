                        ...
                        <IonRow>
                          ...
                          {/* {
                            this.state.showPriceTable ? (
                              <p style={{color:"black",fontWeight:"700"}}>Revise Membership Fee from 01/04/2024</p>
                            ):null
                          }
                          {
                         this.state.showPriceTable ?  (
                          
                          <IonGrid className="newRatetables">
                           
                            <IonRow>
                                <IonCol style={{fontWeight:"bold"}}>Admission Fees</IonCol>
                                <IonCol style={{fontWeight:"bold"}}>Annual subscription</IonCol>
                                <IonCol style={{fontWeight:"bold"}}>Turnover</IonCol>
                            </IonRow>
                            <IonRow>
                                <IonCol>Rs 1000</IonCol>
                                <IonCol>Rs 4000</IonCol>
                                <IonCol>Upto Rs. 1 Crore</IonCol>
                            </IonRow>
                            <IonRow>
                                <IonCol>Rs 1000</IonCol>
                                <IonCol>Rs 7000</IonCol>
                                <IonCol>Rs. 1 Crore - 3 Crore</IonCol>
                            </IonRow>
                            <IonRow>
                                <IonCol>Rs 1000</IonCol>
                                <IonCol>Rs 10000</IonCol>
                                <IonCol>Above Rs.3 Crore</IonCol>
                            </IonRow>
                          </IonGrid>
                         ) : null
                        } */}
                          <p className="hoTComment" style={{color:"black",fontWeight:"bold",fontStyle:"unset"}}>
                          2- Membership fee valid for 365 days.
                          </p>
                        </IonRow>
                        
                        <IonModal  isOpen={this.state.showPriceTable } cssClass="newpricemodal">
                      
                        <IonContent className="ion-padding">
                          <p className="closeIcon"><span onClick={(e) => { this.setState({ showPriceTable:false}) }}>X</span></p>
                            <p style={{color:"black",fontWeight:"700"}}>Revise Membership Fee from 01/04/2024</p>
                            <IonGrid className="newRatetables">
